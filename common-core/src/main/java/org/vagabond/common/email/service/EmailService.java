package org.vagabond.common.email.service;
...
import org.vagabond.common.email.repository.EmailRepository;
...
public class EmailService extends BaseService<EmailEntity> {
    ...
    public void finishEmail(EmailEntity email) {
        ...
        getRepository().getEntityManager().createQuery(hqlLink).setParameter("emailId", email.id)
                .executeUpdate();
    }
