...
public abstract class BaseUploadResource<T extends BaseCrudEntity, U extends BaseUserEntity<?>> extends BaseCrudResource<T, U> {
    ...
    public void doBeforeUpload(U userConnected, Long id) {
    }
